...
class TestGLTFBatchMode:
    ...
    def test_batch_combine_mode(self, create_cube, create_sphere, temp_export_dir, reset_settings):
        ...
        assert glb_count == 1, "Should create only one combined GLB file in COMBINE mode"

    def test_batch_individual_mode(self, create_cube, create_sphere, temp_export_dir, reset_settings):
    ...
    def test_batch_mode_with_json_gltf(self, create_cube, create_sphere, temp_export_dir, reset_settings):
...
class TestBatchModeWithCollections:
    ...
    def test_batch_combine_with_collection(self, create_collection, temp_export_dir, reset_settings):
    ...
    def test_batch_combine_mixed_collections(self, temp_export_dir, reset_settings):
        ...
        result = bpy.ops.mesh.batch_export_selected()
        assert result == {'FINISHED'}, "Batch export with mixed collections should succeed"
...
class TestBatchModeWithLOD:
    ...
    def test_batch_combine_with_lod(self, create_cube, create_sphere, temp_export_dir, reset_settings):
    ...
    def test_batch_individual_with_lod(self, create_cube, create_sphere, temp_export_dir, reset_settings):
...
class TestBatchModeOnlyForGLTF:
    ...
    def test_batch_mode_ignored_for_fbx(self, create_cube, create_sphere, temp_export_dir, reset_settings):
        ...
        assert fbx_count == 2, "FBX should ignore batch mode and create individual files"

    def test_batch_mode_ignored_for_obj(self, create_cube, create_sphere, temp_export_dir, reset_settings):
        ...
        assert obj_count == 2, "OBJ should ignore batch mode and create individual files"


class TestBatchModeWithNamingConventions:
    """Tests for batch mode with naming conventions applied."""

    def test_batch_combine_with_godot_naming(self, create_cube, create_sphere, temp_export_dir, reset_settings):
    ...
    def test_batch_combine_with_prefix_suffix(self, create_cube, create_sphere, temp_export_dir, reset_settings):
